...
export const RATE_LIMITS = {
  ...
  // Exchanging an emailed link for a cookie. The tokens are 256-bit, so
  // this is not what stops a brute force — it stops unlimited lookups
  // burning database queries, and it makes a scan visible.
  tokenExchange: { limit: 20, windowSeconds: 15 * 60 },
